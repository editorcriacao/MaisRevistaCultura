...
<div id="cadastro">
    ...
    <span style="font-size: 10px; font-family: arial; color: #333;  margin-top: -10px; position: absolute; display:none" id="error-email">Campo E-MAIL não pode ficar vazio ou o Campo E-MAIL tem que ser um e-mail válido.</span>
    ...
    <?php echo $this->Form->input('confirmar_senha_usuario', array('label' => 'Confirmar Senha: ', 'size' => '20', 'id'=>'senha-2', 'type'=>'password')) ?>
        ...
        <br /><br>
        <br />
        <p style="font-size: 14px; color: #333; font-family: arial;">Deseja receber newsletters com novidades, promoções, eventos e outras informações?</p><br />
